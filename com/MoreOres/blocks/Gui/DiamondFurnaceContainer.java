...
public class DiamondFurnaceContainer extends Container{
	...
	private DiamondFurnaceTileEntity diamondFurnace;

	public DiamondFurnaceContainer(InventoryPlayer inventory, DiamondFurnaceTileEntity tileentity) {
	 ...
	 public ItemStack transferStackInSlot(EntityPlayer par1EntityPlayer, int par2)
	    {
	        ...
	        if (slot != null && slot.getHasStack())
	        {
	            ...
	            else if (par2 != 1 && par2 != 0)
	            {
	                ...
	                else if (DiamondFurnaceTileEntity.isItemFuel(itemstack1))
	                {
