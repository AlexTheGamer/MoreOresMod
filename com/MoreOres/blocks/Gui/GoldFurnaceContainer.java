...
public class GoldFurnaceContainer extends Container{
	
	public int lastBurnTime;
	public int lastCurrentItemBurnTime;
	public int lastCookTime;

	private GoldFurnaceTileEntity goldFurnace;

	public GoldFurnaceContainer(InventoryPlayer inventory, GoldFurnaceTileEntity tileentity) {
	 ...
	 public ItemStack transferStackInSlot(EntityPlayer par1EntityPlayer, int par2)
	    {
	        ...
	        if (slot != null && slot.getHasStack())
	        {
	            ...
	            else if (par2 != 1 && par2 != 0)
	            {
	                ...
	                else if (GoldFurnaceTileEntity.isItemFuel(itemstack1))
	                {
