...
private IronFurnaceTileEntity ironFurnace;

public IronFurnaceContainer(InventoryPlayer inventory, IronFurnaceTileEntity tileentity) {
 ...
 public ItemStack transferStackInSlot(EntityPlayer par1EntityPlayer, int par2)
    {
        ...
        if (slot != null && slot.getHasStack())
        {
            ...
            else if (par2 != 1 && par2 != 0)
            {
                ...
                else if (IronFurnaceTileEntity.isItemFuel(itemstack1))
                {
