...
public class IronFurnace extends BlockContainer{
	...
	public void registerBlockIcons(IIconRegister iconRegister) {
		this.blockIcon = iconRegister.registerIcon(References.MODID + ":" + "iron_side");
		this.iconFront = iconRegister.registerIcon(References.MODID + ":" + (this.isActive ? "ironActive" : "ironIdle"));
		this.iconTop = iconRegister.registerIcon(References.MODID + ":" + "iron_top");
	}
	...
	public Item getItemDropped(int i, Random random, int j) {
		return Item.getItemFromBlock(BlocksandItems.IronFurnaceIdle);
	}
	...
	public boolean onBlockActivated(World world, int x, int y, int z, EntityPlayer player, int side, float hitX, float hitY, float hitZ) {
		if(!world.isRemote) {
			FMLNetworkHandler.openGui(player, mainRegistry.instance, BlocksandItems.guiIDIronFurnace, world, x, y, z);
		}
		return true;
	}
	...
	public void onBlockPlacedBy(World world, int x, int y, int z, EntityLivingBase entityplayer, ItemStack itemstack) {
		...
		if(itemstack.hasDisplayName()) {
			((IronFurnaceTileEntity)world.getTileEntity(x, y, z)).setGuiDisplayName(itemstack.getDisplayName());
		}
	}
	...
	public static void updateIronFurnaceBlockState(boolean active, World worldObj, int xCoord, int yCoord, int zCoord) {
		...
		if(active) {
			worldObj.setBlock(xCoord, yCoord, zCoord, BlocksandItems.IronFurnaceActive);
		}else{
			worldObj.setBlock(xCoord, yCoord, zCoord, BlocksandItems.IronFurnaceIdle);
		}
	...
	public void breakBlock(World world, int x, int y, int z, Block oldblock, int oldMetadata) {
		if(!keepInventory) {
			IronFurnaceTileEntity tileentity = (IronFurnaceTileEntity) world.getTileEntity(x, y, z);
